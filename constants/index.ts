...
export const FEATURES = [
  ...
  {
    title:
      "Providing a comprehensive eye examination using the latest technology",
...
export const OFFERS = [
  ...
  },
  {
    service: "Contact Lenses",
    offerDetails:
      "Buy 2 months worth of contact lenses and get one month free - includes single vision, toric, multifocal, monthly and daily lenses.",
    expiryDate: "14/08/24",
  },
  {
    service: "Designer Frames",
    offerDetails:
      "Ted Baker frames - 2 for £195 including single vision lenses",
    expiryDate: "Ongoing Offers",
  },
  {
    service: "Eye Exam",
...
export const REVIEWS = [
  {
    avatar: "./kathReview.png",
    name: "Katherine Dempsey",
    review:
      "Despite my own ailment, had a lovely experience in store. the staff were courteous, respectful, and very informative.",
    time: "3 months ago"
  },
  {
    avatar: "./haydenReview.png",
    name: "Hayden Moody",
    review:
      "The optician was great with my 4-year-old son. very professional, friendly, and informative.",
    time: "4 months ago"

  },
  {
    avatar: "./maureenReview.png",
    name: "Maureen Wilson",
    review:
      "So so happy with my new glasses 👓 care and attention paid in all areas to my complicated prescription so happy with the service Thank-you",
    time: "6 months ago"
  },
];
